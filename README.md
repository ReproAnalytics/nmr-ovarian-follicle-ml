...
Please read the 'Getting Started' guide before starting the project: https://github.com/ReproAnalytics/nmr-ovarian-follicle-ml/blob/main/getting_started.sh 
